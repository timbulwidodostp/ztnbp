...
{title:Examples}
{phang}import excel "https://raw.githubusercontent.com/timbulwidodostp/quaids/main/quaids/quaids.xlsx", sheet("Sheet1") firstrow clear{p_end}
{phang}ztnbp los died hmo type1 type2 type3{p_end}
{phang}ztnbp los died hmo type1 type2 type3, vce(cluster provnum){p_end}
